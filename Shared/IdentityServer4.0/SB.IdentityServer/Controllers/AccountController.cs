...
namespace IdentityServerWithAspNetIdentity.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Logout(LogoutViewModel model)
        {
            ...
            if (idp != null && idp != IdentityServerConstants.LocalIdentityProvider)
            {
                ...
                try
                {
                    ...
                    //await HttpContext.SignOutAsync(idp, new Microsoft.AspNetCore.Authentication.AuthenticationProperties { RedirectUri = url });
                    //await HttpContext.SignOutAsync(IdentityConstants.ApplicationScheme, new Microsoft.AspNetCore.Authentication.AuthenticationProperties { RedirectUri = url });
                }
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                int userType = Convert.ToInt32(UserType.Customer);  //This will be passed...
                ...
                switch ((UserType) userType)
                    ...
                    case UserType.Customer:
                        dataEventsRole = "dataEventRecords.user";
                        securedFilesRole = "securedFiles.user";
                        break;
                }

                var user = new ApplicationUser { UserName = model.Email, Email = model.Email,
                    UserType = userType, PhoneNumber = model.PhoneNumber,
                    FirstName = model.FirstName, MiddleName = model.MiddleName, LastName = model.LastName,
                    CreateDate = DateTime.UtcNow, ModifyDate = DateTime.UtcNow, AppId = model.AppId, AppRoleId = model.AppRoleId, CreatedBy = 1,
                    CustomerPhoto = "",StartDate = DateTime.UtcNow,EndDate = DateTime.UtcNow,DataEventRecordsRole=dataEventsRole,SecuredFilesRole=securedFilesRole
                };
                ...
                if (result.Succeeded)
                {
                    ...
                    TempData["AccountMessage"] = " Thank you for Account registration. We have sent an account activation link on your email address , please activate your account using that link.";
                    return RedirectToLocal(returnUrl);
                }
                AddErrors(result);
            }
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null, string remoteError = null)
        {
            ...
            else
            {
                ...
                var user = new ApplicationUser
                {
                    ...
                    FirstName = firstName,
                    LastName = lastName,
                    UserType = Convert.ToInt32(UserType.Customer),
        ...
        public async Task<IActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl = null)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, FirstName = model.FirstName, LastName = model.LastName,UserType = Convert.ToInt32(UserType.Customer),CreateDate = DateTime.UtcNow, ModifyDate = DateTime.UtcNow, EmailConfirmed = true
                };
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (model.SendCode == "Email")
                {
                    var callbackUrl = Url.Action("ResetPassword", "Account", new { userId = user.Id, code = code }, protocol: HttpContext.Request.Scheme);
                    await _emailSender.SendEmailAsync(model.Email, "Reset Password",
                       $"Please reset your password by clicking here: <a href='{callbackUrl}'>link</a>");
                }
                else if (model.SendCode == "Phone")
                {
